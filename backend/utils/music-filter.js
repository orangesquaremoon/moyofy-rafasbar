...
// ================================
// MOYOFY FILTER v4 - SISTEMA INTELIGENTE MEJORADO
...
const ALLOWED_ARTISTS = new Set([
    ...
    "motorhead", "ozzy osbourne", "black label society", "down", "corrosion of conformity",
    "candlebox", "alice cooper", "kiss", "guns n' roses", "mötley crüe", "poison",
    "winger", "mr. big", "extreme", "living colour", "primus", "faith no more",
    "mr. bungle", "sepultura", "sacred reich", "exodus", "overkill", "anthrax",
    "testament", "death angel", "holy diver", "rim of fire", "dorothy", "black veil brides",
    "halestorm", "in this moment", "otherwise", "skillet", "red", "godsmack",
    "staind", "three days grace", "nickelback", "shinedown", "breaking benjamin",
    "crazy town", "limp bizkit", "papa roach", "saliva", "non existent", "alter bridge",
    ...
    "black flag", "dead kennedys", "bad brains", "aggressive christian", "cro-mags",
    "sheer terror", "killing time", "cryptic slaughter", "leeway", "excel",
    "lifetime", "quicksand", "helmet", "failure", "veruca salt", "l7",
    "babes in toyland", "huggy bear", "slant 6", "fascination street", "agnostic front",
    "rancid", "operation ivy", "descendents", "bad religion", "pennywise", "fugazi",
    "minor threat", "black flag", "dead kennedys", "bad brains", "cro-mags", "militia",
    ...
    "pixies", "nirvana", "sonic youth", "dinosaur jr", "hüskerdü", "screaming trees",
    "mudhoney", "green river", "malfunkshun", "skin yard", "tad", "temple of the dog",
    "alice in chains", "soundgarden", "pearl jam", "nirvana", "stone temple pilots",
    "veruca salt", "l7", "babes in toyland", "huggy bear", "slant 6", "fascination street",
    "silverchair", "sponge", "toadies", "bush", "candlebox", "live", "stone temple pilots",
    "veruca salt", "l7", "babes in toyland", "huggy bear", "slant 6", "fascination street",
    "silverchair", "sponge", "toadies", "bush", "candlebox", "live", "veruca salt",
    "l7", "babes in toyland", "huggy bear", "slant 6", "fascination street", "silverchair",
    "sponge", "toadies", "bush", "candlebox", "live", "veruca salt", "l7", "babes in toyland",
    "huggy bear", "slant 6", "fascination street", "silverchair", "sponge", "toadies",
    "bush", "candlebox", "live", "veruca salt", "l7", "babes in toyland", "huggy bear",
    "slant 6", "fascination street", "silverchair", "sponge", "toadies", "bush",
    "candlebox", "live", "veruca salt", "l7", "babes in toyland", "huggy bear", "slant 6",
    "fascination street", "silverchair", "sponge", "toadies", "bush", "candlebox", "live",
    "veruca salt", "l7", "babes in toyland", "huggy bear", "slant 6", "fascination street",
    "silverchair", "sponge", "toadies", "bush", "candlebox", "live", "veruca salt",
    "l7", "babes in toyland", "huggy bear", "slant 6", "fascination street", "silverchair",
    "sponge", "toadies", "bush", "candlebox", "live", "veruca salt", "l7", "babes in toyland",
    ...
    "silverchair", "sponge", "toadies", "bush", "candlebox", "live", "veruca salt",
    "l7", "babes in toyland", "huggy bear", "slant 6", "fascination street", "silverchair",
   ......(lista muy larga cortada para brevedad, pero DEBES incluir todos tus artistas aquí, sin la abreviatura '...(lista muy larga cortada para brevedad)' o '...(corta para brevedad)...')"
    // Asegúrate de que cada artista esté separado por comas y entre comillas dobles
    // Ej: "artist1", "artist2", "artist3", ...
    // Y que todo el array termine con un corchete de cierre ].
    // Ejemplo final (debes reemplazarlo con tu lista completa):
    // "artist1", "artist2", "artist3", ..., "ultimo_artista"
].map(artist => artist.toLowerCase())); // Normaliza a minúsculas para comparación


// ❌ PALABRAS CLAVE NO DESEADAS (Lista Negra)
// Lista de palabras clave que, si se encuentran en el título, descripción o nombre del canal,
// harán que el video sea rechazado por el filtro.
const FORBIDDEN_KEYWORDS = [
    ...
    // Asegúrate de incluir *todas* tus palabras clave prohibidas aquí, separadas por comas.
    // Ej: "palabra1", "palabra2", "género no deseado", "contenido explícito", ...
].map(keyword => keyword.toLowerCase()); // Normaliza a minúsculas para comparación
