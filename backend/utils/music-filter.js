...
const ALLOWED_ARTISTS = new Set([
  ...
  // ... (agrega aquí todos tus artistas permitidos) ...
  // Por brevedad, no se incluyen todos, pero asegúrate de tenerlos todos aquí
...
const FORBIDDEN_KEYWORDS = [
  ...
  "heart", "mind", "brain", "soul", "ghost", "monster", "fantasy",
  ...
  "delicate", "sturdy", "flimsy", "solid", "hollow", "empty", "filled",
  ...
  "text-combine-upright", "ruby-align", "ruby-position", "hanging-punctuation",
  ...
  "tab-size", "text-justify", "text-outline", "text-fill-color", "text-stroke",
  "text-emphasis", "text-emphasis-style", "text-emphasis-color", "text-emphasis-position",
  "writing-mode", "text-orientation", "text......(lista muy larga cortada para brevedad)"
